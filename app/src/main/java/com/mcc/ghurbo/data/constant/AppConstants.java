package com.mcc.ghurbo.data.constant;
...
public class AppConstants {
    ...
    public static final String BUNDLE_ROOM_DETAILS = "room_details";
    public static final String BUNDLE_FROM_BOOKING = "from_booking";
